...
public class PiecePawn extends Piece {
    ...
    public PiecePawn(int type, int xPos, int yPos, ComputerController controller) {
        ...
        if (type == 1) {
            ...
            image = new Image("file:src/main/resources/bPawn.png");
            imageView.setImage(image);
            imageView.fitHeightProperty();
            imageView.fitWidthProperty();
            imageView.setPreserveRatio(true);
    ...
    public void SelectPiece(ChessBoard chessBoard) {
        ...
        if (this.type == 1) {
            if (!gameLogic.slashDiagonalProtection(chessBoard, this.xPos, this.yPos, this.type) &&
                ...
                if (this.isFirstTime && chessBoard.getBoardPosition(this.xPos, this.yPos - 2) == 0) {
                    if (chessBoard.checkState) {
            ...
            if (!gameLogic.verticalProtection(chessBoard, this.xPos, this.yPos, this.type)) {
                if (!gameLogic.slashDiagonalProtection(chessBoard, this.xPos, this.yPos, this.type)) {
                    if (this.yPos - 1 >= 0 && this.xPos - 1 >= 0 &&
                            chessBoard.getBoardPosition(this.xPos - 1, this.yPos - 1) != this.type &&
                            chessBoard.getBoardPosition(this.xPos - 1, this.yPos - 1) != 0) {
                        if (chessBoard.checkState) {
                            if (gameLogic.isThisProtecting(chessBoard, this.xPos - 1,
                ...
                if (!gameLogic.backslashDiagonalProtection(chessBoard, this.xPos, this.yPos, this.type)) {
                    if (this.yPos - 1 >= 0 && this.xPos + 1 < chessBoard.getBoardWidth() &&
                            chessBoard.getBoardPosition(this.xPos + 1, this.yPos - 1) != this.type &&
                            chessBoard.getBoardPosition(this.xPos + 1, this.yPos - 1) != 0) {
                        if (chessBoard.checkState) {
                            if (gameLogic.isThisProtecting(chessBoard, this.xPos + 1,
            ...
            if (!gameLogic.slashDiagonalProtection(chessBoard, this.xPos, this.yPos, this.type) &&
                    !gameLogic.backslashDiagonalProtection(chessBoard, this.xPos, this.yPos, this.type)) {
                if (this.yPos + 1 < chessBoard.getBoardHeight() && chessBoard.getBoardPosition(this.xPos,
                        this.yPos + 1) == 0) {
                    if (chessBoard.checkState) {
                        if (gameLogic.isThisProtecting(chessBoard, this.xPos, this.yPos + 1, this.type))
                            chessBoard.colorSquare(this.xPos, this.yPos + 1, false);
            ...
            if (!gameLogic.verticalProtection(chessBoard, this.xPos, this.yPos, this.type)) {
                if (!gameLogic.backslashDiagonalProtection(chessBoard, this.xPos, this.yPos, this.type)) {
                    if (this.yPos + 1 < chessBoard.getBoardHeight() && this.xPos - 1 >= 0 &&
                            chessBoard.getBoardPosition(this.xPos - 1, this.yPos + 1) != this.type &&
                            chessBoard.getBoardPosition(this.xPos - 1, this.yPos + 1) != 0) {
                        if (chessBoard.checkState) {
                            if (gameLogic.isThisProtecting(chessBoard, this.xPos - 1,
                ...
                if (!gameLogic.slashDiagonalProtection(chessBoard, this.xPos, this.yPos, this.type)) {
                    if (this.yPos + 1 < chessBoard.getBoardHeight() && this.xPos + 1 < chessBoard.getBoardWidth() &&
                            chessBoard.getBoardPosition(this.xPos + 1, this.yPos + 1) != this.type &&
                            chessBoard.getBoardPosition(this.xPos + 1, this.yPos + 1) != 0) {
                        if (chessBoard.checkState) {
                            if (gameLogic.isThisProtecting(chessBoard, this.xPos + 1,
